...
procedure TfrmAquarium.bmbClearClick(Sender: TObject);
begin
...
begin
  ...
  redAfvoer.Lines.Add('Total liters: ' + FloatToStrF(rVolL,ffFixed,10,2));
...
begin
 ...
 redAfvoer.Lines.Add('Total UK Gallons: ' + FloatToStrF(rVolK,ffFixed,10,2));
end;
...
begin
 ...
 redAfvoer.Lines.Add('Total US Gallons: ' + FloatToStrF(rVolK,ffFixed,10,2));
end;
