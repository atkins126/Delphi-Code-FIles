...
redtOutput.Clear;
  ...
  if rbSalad.Checked
   then
    ...
    ' Salads With ' + IntToStr(iRest) + 'g As Leftovers');
    end;
  ...
  if rbSideDish.Checked
   then
    ...
    ' Side Dishes With ' + IntToStr(iRest) + 'g As Leftovers');
    end;
  ...
  if rbDesert.Checked
   then
    ...
    redtOutput.Lines.Add(IntToStr(iDesert) + 'g Of Food Can Make ' + IntToStr(iAdult) +
    ' Deserts With ' + IntToStr(iRest) + 'g As Leftovers');
    end;
